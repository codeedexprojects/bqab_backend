...
exports.getTournamentById = async (req, res) => {
  try {
    ...
    // Process umpires data - FIXED: Handle null umpire references
    const umpires = tournament.umpires
      .filter(umpireAssignment => umpireAssignment.umpire !== null) // Filter out null umpires
      .map(umpireAssignment => ({
